...
RSPPlayer_305428369::RSPPlayer_305428369() {
...
void RSPPlayer_305428369::updateOpponentPieces(char piece, int x, int y, int newX, int newY) {
...
void RSPPlayer_305428369::notifyOnInitialBoard(const Board& b, const std::vector<std::unique_ptr<FightInfo>>& fights) {
	for (int i = 1; i <= M; i++) {
		for (int j = 1; j <= N; j++) {
...
void RSPPlayer_305428369::notifyOnOpponentMove(const Move& move) { // Updated my board
	this->movesCounter++;
...
void RSPPlayer_305428369::notifyFightResult(const FightInfo &fightInfo) {
	this->updateBoardByBattle(fightInfo);
}

void RSPPlayer_305428369::updateBoardByBattle(const FightInfo &fightInfo) {
...
void RSPPlayer_305428369::getInitialPositions(int player, std::vector<std::unique_ptr<PiecePosition>> &vectorToFill) {
...
double RSPPlayer_305428369::evaluateMove(char piece, int x, int y) {
...
std::unique_ptr<JokerChange> RSPPlayer_305428369::getJokerChange() {
